...
const InputPrice = ({ marginTop = 0, marginBottom = 0, marginLeft = 0, marginRight = 0, width = { size: 0, type: "rem", resizeAdjust: true }, defaultValue = "", value, onChange = () => null, label = { value: "", requiredInput: false, color: "#707070" }, disabled = false, error = { isError: false, text: "Um texto vai aqui!" }, name = "" }) => {
    ...
    return (_jsx(_Fragment, { children: _jsxs(Div, { style: {
                ...
                opacity: disabled ? "0.5" : "1",
                        ...
                        color: error.isError ? "#e0457b" : label.color,
                    }, children: [label.value, label.requiredInput ? _jsx("span", { style: { color: "#e0457b" }, children: " *" }) : ""] })), _jsxs("div", { className: "input-area", children: [_jsx("input", { name: name, autoComplete: "off", disabled: disabled, value: value !== undefined ? convertMoney(value, value.includes("-") ? true : false, false) : inputValue, onChange: (ev) => {
                            ...
                            && !disabled && (_jsx("img", { className: "remove-text", src: xMarkSolid, alt: "icon", onClick: () => {
                                setInputValue("");
                                onChange({ brl: "", float: "" });
